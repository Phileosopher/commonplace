...
The syntax changes depending on the programming language, but the following implementation is from JavaScript here. Here are some examples of text to search:
