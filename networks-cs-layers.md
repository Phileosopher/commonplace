...
The Application layer is a bit of a weird catchall. It merges closely with [front-end development](computers-software.md), since it deals heavily with [how the user perceives the information](engineering-design.md).
