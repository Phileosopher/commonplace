...
Folder - aka directory, a file inside a file system that divides out files as if they were in a box, permits easy organization as well as the ability to name multiple files the same name by placing them in different logical locations
...
FUD - fear, uncertainty, and disorder, the things necessary to successfully carry out a cyberattack
...
Hard link - duplicate links where both entries point to the same file, contrast with symlink
...
Header - supplemental data at the beginning of a file or packet that isn't part of the "body" of main data, used for [storage](cs-memory.md) or [network transmission](cs-networks.md) reasons, contains metadata
...
IoT - Internet of things, every device, even special-use ones, has an IP address, creating tremendous opportunities as well as [cybersecurity](cs-infosec.md) risks
...
IT - information technology, basically everything about a computer

IT asset - a specific piece of IT
...
LLC - logical link control, a subset of the [Data Link layer](cs-networks.md) that deals with directing information to and from various nodes, moves from media access control (MAC)
