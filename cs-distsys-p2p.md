...
Before going into the technical side of it, it's worth understanding how "peer-to-peer" (P2P) [protocols](cs-standards.md) work:
...
There are [many P2P protocols](https://en.wikipedia.org/wiki/List_of_P2P_protocols), but the most popular [network protocol](cs-networks.md) for P2P, by far, is the [BitTorrent protocol](cs-distsys-p2p-torrent.md).
