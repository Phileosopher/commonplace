...
- Unless it's a glider, there is a very real chance of stalling and free-falling to the ground as soon as the [engine](engineering-engines.md) fails.
...
- Midair collision is magnified by visibility and navigation factors from [weather](science-weather.md) (e.g., hail, fog, wind).
...
- Auto-kinesis - a point in a dark and featureless background starts to move, comes from staring at it too long
- Graveyard spiral - not noticing a bank and attitude change, pulling up can cause a spiral
