...
The onset of [the internet](cs-browser.md) makes education trivially easy.
...
- Given [the absurdly difficult challenges natural to merely living in the same building together](relationships-marriage.md), we should start with imitating the modeling done within the vast variety of healthy marriages sprinkled across society.
