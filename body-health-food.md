...
- A body that works with too many carbs for long enough will suffer an insulin production disease (i.e., diabetes), though it can often be offset by [exercise](body-exercise.md).
