...
TCP - transmission control protocol, the [Transport-level](cs-networks.md) standard for sending high-quality information across a network, in contrast with UDP
...
UDP - user datagram protocol, the [Transport-level](cs-networks.md) standard for sending information rapidly across a network, contrast to TCP
...
Vibe coding - using machine learning algorithms to generate sloppy code without knowing what the code actually does
...
Viewport - the size of what is being expressed on the screen (such as the [browser](cs-browser.md)), can often change with the zoom feature
...
Voicemail - a standardized redirect when someone doesn't answer a phone call
