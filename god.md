...
Some of God's qualities are explicitly defined in [the Bible](bible.md), and can only be true, without room for philosophical [speculation](imagination.md).

- That doesn't mean we can't take guesses at many other components of God, but it does mean there are certain constants.

Even without [the Bible](bible.md), we can still [logically](logic.md) conclude God's existence through induction.
...
With God being a Trinity, by [deduction](logic.md) each Person will have a different [perspective](image.md), each with at least a slightly different [understanding](understanding.md) of something:
...
God created us in His [image](image.md), but we aren't God:
...
God isn't [conventional](habits.md) or [predictable](imagination.md).
