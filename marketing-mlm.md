...
3. Before applying for a conventional job, applicants *already* want to succeed at it before they've applied.

MLM, on the other hand, devotes a *lot* of effort towards the recruiting process.

- The only required qualification is the willingness to do it.
...
The model is also questionably illegal.
...
- In this example, the MLM model would need to sell 214 units just to break even with the conventional model, and selling 15 fewer would only give 3/4 of the income than a typical sales commission.
...
- Like any other [cult](people-culture-cults.md), anyone who questions organizational decisions or requests more input will receive shame from the community.
...
MLM representatives, like [cult members](people-culture-cults.md), don't hold MLM directly responsible.
...
- Many MLM members transition into other [addictions](addiction.md) or [cults](people-culture-cults.md), including other MLMs.
...
Often, someone in MLM will try to convince you that it's not MLM, even [when the internet says they are](marketing-mlm-list.md). They'll usually use the words network marketing, direct selling, referral marketing, affiliate marketing, and pyramid selling.
