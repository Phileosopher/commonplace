...
We face [conflicts](conflicts-inner.md) about what we want. If we have *any* conflict about what we [imagine](imagination.md) [doing](mind-creativity-results.md) or [believing](understanding-certainty.md), we must deny a [sentiment](mind-feelings.md) to [act](creations.md) toward a repeat of that action. "Willpower" is the amount of resistance we must use to make a particular decision.
...
We feel comfortable handing off most decisions to the subconscious, except for when that decision either may create [painful](mind-feelings-fear.md) [results](mind-creativity-results.md) or makes us feel something [unfamiliar](understanding-certainty.md).
...
- How much [effort](mind-creativity-results.md) we'd have to do to complete something.
...
- How what we [do](mind-creativity-results.md) could [influence](power-influence.md) others.
- The [understanding](understanding.md) we could gain, to the degree of our [curiosity](purpose.md).
- [Technology](technology.md) we can use to [optimize](success-4_routine.md) our [routines](habits.md) or magnify our [work](mind-creativity-results.md).
...
2. Decide toward [outward action](mind-creativity-results.md) or inaction.
...
Even with the above-stated variables, our calculation is typically not very thorough. We tend to attribute the cause for why we do things *after* we experience [results](mind-creativity-results.md) from those decisions, but forget that we were acting mostly on [intuition](mind-feelings.md) at the time we decided.
...
- Actions we [observe](image.md) or [do](mind-creativity-results.md) that are [improper](rules.md) or [taboo](morality-taboo.md).
