...
[Intellectual property](https://notageni.us/ip/) is big money. People don't like their stuff getting copied. While it doesn't legitimately reflect the original term (hijacking and committing violent acts in a remote area), the legal term for illegally or pseudo-legally copying IPs is known as "piracy".
...
Even with punitive measures that would drive any convict to prison and make them [indebted for life](https://gainedin.site/slavery/), most pirates get away with it, and there are *constant* new pirates joining, even with the clearly apparent risks of the decision.

As the [internet](/web-dev/) has grown, piracy has as well, and entails quite a few forms of computer information:

- [Software](/software-design/)
- Copyrighted media such as music, movies, and books
- Databases, including [hacked data](/pentest/)
- Trade secrets
...
1. Most [intellectual property](https://notageni.us/ip/) treats digital content as an extension of physical things, but in computers "moving" anything digitally is actually copy-then-delete. Giving a book to a friend isn't violating copyright, but is technically a violation by emailing it and not deleting the original copy.
2. DRM often breaks the usability for the legitimate owners of the device, meaning users may be *forced* to [hack](/hacking/) their rightfully owned property.
...
5. The willpower of the hacking/"cracking" community mean very clever [hacks](/hacking/) come out shortly after media releases with DRM:
...
6. Further, if an IP-holder gets *too* oppressive with their rights management, for a variety of reasons they'll often see typical consumers pirate copies or use alternative products (e.g., [open-source](/floss/)).
...
There's not much scientific information about money lost on IPs, but the EU *did* try to suppress [a 300-page scientific study](https://felixreda.eu/wp-content/uploads/2017/09/displacement_study.pdf) that indicates that the only time [IP](https://notageni.us/ip/)-holders lose money is when it's a new release. This does make sense, since media typically becomes easy to acquire (and also part of the public consciousness to where it's not as [in-demand](https://gainedin.site/economics/)) proportionally to how long it has been published.

This doesn't change the current legality of intellectual property, though. There are specific clauses such as fair use that permit educational purposes and parody, and many varieties of more lenient IPs exist for people who don't feel driven to the severely confining scope of copyright (e.g., [creative commons](https://notageni.us/ip/), [LGPL](/floss/)).

* * * * *

## P2P protocols

Before going further, it's worth understanding how "peer-to-peer" (P2P) [protocols](/protocols/) work:
...
- Magnet links can be quickly and easily converted into a [hash](/encryption/) for quickly referencing the information across the internet.

There are [many P2P protocols](https://en.wikipedia.org/wiki/List_of_P2P_protocols), but the most popular [network protocol](/networks/) for P2P, by far, is the BitTorrent protocol. "Torrenting" operates on a relatively straightforward system:

1. A computer (typically a "tracker") hosts a "magnet link" as a .torrent file, which specifies a [hash](/encryption/) that a BitTorrent "client" can open.
...
9. When there are enough clients seeding, the content has a torrent "swarm", and is pretty much impossible to take down without destroying *all* the [network connections](/networks/) of those computers at once. Enabling a "distributed hash table" (DHT) in the client can magnify user interactions after the initial leeching.
...
Some sites, such as thePirateBay, host public "trackers", where anyone can download and share content, and they typically have more leechers and fewer seeders, as well as risks of [malware](/malware/), [crypto miners](/blockchain/), or third-party [DRM](https://notageni.us/ip/).
...
Most private trackers [specialize](https://gainedin.site/specialization-cities/) in older, non-mainstream content, which is far less likely to lead to an [intellectual property](https://notageni.us/ip/) suit/enforcement.
...
- They also typically hire staff who test whether the content is [malware](/malware/) before seeding it.
- Further, they'll frequently take content requests for other available media.

The only way to join private trackers is through a well-established reputation on specific invite forums, which often includes uploading new content in some capacity. The content can then be shared indefinitely via a [hosted](/cloud/) "seedbox" or temporarily via a "debrid". The entire community is *very* close-knit, and tracker managers frequently ban people who abuse the system or [exploit it](/hacking/) via invites.

The chances of finding [malware](/malware/) on a public tracker is *much* higher, as well as the odds of being monitored by a government intelligence agency.
...
- Various other [protocols](/protocols/) (e.g., Usenet)
- "Bots" and "scripts" that automate everything
- Public websites and folders that allow direct download.

Pirated content travels through a type of [supply chain](https://notageni.us/logistics/) from its original availability to mass dissemination:
...
1. Warez scene groups - aka scene, relatively small groups of people crack software and directly release "ripped" media content and cracked "warez".
   - They're typically the most tech-savvy group, and live by [*very* strict community guidelines](https://scenerules.org/) that floats close to the [protocol standards](/protocols/).
...
2. Top sites - high-powered servers that use [FTP](/protocols/) to send large amounts of files.
...
3. Couriers/"racers" - individuals who trade content between pirated sites.
   ...
   - Alongside FTP, they'll use an IRC [sub-protocol](/protocols/) called XDCC to upload large files, often on [compromised computers](/pentest/).
...
4. Average people - individuals who simply want a free or non-DRM version of media/software.
   - Since software is executable, most [malware](/malware/) for many people comes bundled within public torrents.
   - For the most part, if a user simply [virus scans](/cysec/) any downloaded content, they won't get any malware.
...
In short, piracy is a portion of the never-ending arms race within the larger domain of [cybersecurity](/cysec/). Every site torn down is only a fraction of where the content is available.

- Any formal efforts to suppress it will, like every other aspect of [human nature](https://gainedin.site/rules/), drive it underground.
- The implementation of circumventing the law is constantly changing to respond to the situation ([IP](https://notageni.us/ip/)-disrespecting government, endless rapidly-deployed [websites](/web-dev/), [new decentralized protocols](/protocols/), [new network infrastructure](/networks/)).
- The piracy community, however, sees the legislative moves as a type of challenge to overcome, and they're *constantly* changing tactics, with endless temporary [storage](/memory/) and [decentralization](/dist-sys/) for just about everything.
- In fact, the only way to sufficiently crush internet piracy is to employ a single, worldwide [government](https://gainedin.site/political-systems/) that micromanages [human freedoms](https://gainedin.site/boundaries/).

There's no way to fully prevent [intellectual property](https://notageni.us/ip/) violations, since it only takes a few (typically young) people on the internet devoted to uploading content. The only solution to avoid the fight while also making a living is to [release the content for free](/floss/).

The controversy of torrenting has become almost a mainstay of society:

1. As long as [large organizations wish to exert power](https://gainedin.site/groups-large/), and [the law honors it](https://gainedin.site/rules/), they will try to shut piracy down.
2. However, law enforcement only abates the wave, and never successfully shuts anything down completely.
3. New technologies give the public even *more* power. The decentralized BitTorrent protocol, for example, has inspired [blockchain](/blockchain/), which now competes as a strange de facto alternative to [government-issued currency](https://gainedin.site/economics/).

Many software entrepreneurs and executives [aren't particularly aware](/trends/) of the mindset of pirates, and it creates a few odd arrangements:

1. Particularly freedom-loving software developers will open the doors wide-open for [complete software freedom](/floss/), which will attract piracy-based users. This may include free [network use](/networks/), free [storage](/memory/), or [free hosting](/web-dev/).
2. If they're not careful, that [risk exposure](https://notageni.us/risk-mgmt/) will make them stand out as the go-to piracy solution, drawing in more users in that community. If they don't diversify their [marketing](https://notageni.us/marketing/), they'll become [notorious](https://gainedin.site/image/) for piracy-based activities.
...
4. From the point that they've taken a side, their software company has now become a [politicized instrument](https://gainedin.site/conservative-liberal/), either towards that government or towards a libertarian-leaning mentality.
...
The natural design of DRM is to prevent complete use of a product. Sometimes, this can mean the product is *completely* unusable, especially if the company goes out of business and no longer maintains the necessary [authentication](/authentication/) measures for that DRM.
...
To that end, piracy can often allow libraries and archivists to historically preserve software that would otherwise have expired and become lost to permanent [encryption](/encryption/).
...
- General file-sharing has many uses in a P2P environment, such as with [open-source software](/free-software/).
- If the file-sharing is encrypted, it can become P2P [cloud storage](/cloud/).
- If the files can update fast enough, P2P can be useful for [web hosting](/web-dev/).
- P2P banking would mean decentralized monetary management, which has become a major use for [cryptocurrency](/blockchain/).
