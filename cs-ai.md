...
- Make [decisions](mind-decisions.md) to play [games](cs-software-gamedev.md) the way a human does.
...
The first type of AI was created in 1965, and was called an expert system. It operated on a set of if/then rules based on a body of knowledge. It works well-enough for things with a limited set of choices and purely logical decisions (e.g., playing chess, "paper or plastic", [some video games](cs-software-gamedev.md)).
...
[Machine learning](cs-ai-ml.md) is the new AI. If a machine learning [algorithm](cs-langs-algorithms.md) is capable of detecting something, it is also capable of reproducing it. However, because of the work of companies like OpenAI to make the product as *helpful* as possible, they ended up overlooking basic principles of making the results *reliable*. This has resulted in a public disgust about AI starting mid-2026 that will probably last a decade.
