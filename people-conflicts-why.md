...
We *always* start conflicts from a [perceived](people-image-why.md) need:
...
4. While blame is a [power tactic](people-image-distortion.md) in [groups](groups-member.md), it doesn't create any meaningful [results](results.md) because the action to break something is typically different from the action to [fix](https://adequate.life/fix/) it.
...
We like to imagine our conflicts are only with others, but they're not. Our conflicts always start as [Inner dialogue](people-conflicts-inner.md), *then* ripple out to [interpersonal conflicts](people-conflicts.md), which can cascade into larger aspects of [society](people-conflicts-war-why.md).
