...
Before keyboards, people had to make holes in punch cards or paper tape to send information to a computer. If you've ever taken a standardized test where you fill in the numbers with a pencil, imagine having to [code](computers-programming-basics.md) a computer that way.
