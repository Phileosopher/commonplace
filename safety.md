...
We don't like things getting taken from us, especially when we need them to fulfill a [purpose](purpose.md). In fact, we dislike things taken from us proportionally to how much we [imagine](imagination.md) that thing will fulfill present *and* [perceived purposes](power.md).
