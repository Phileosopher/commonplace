...
**Platform errors** are issues with the code once it hits the real world: [network](computers-networks.md) issues, [hard drive](computers-memory.md) failure, invalid [file permissions](computers-cysec.md), etc.
