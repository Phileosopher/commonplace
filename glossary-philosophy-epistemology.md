...
- Methodological behaviorism - Psychological data must be outwardly measurable, so only what people do can be measured or controlled.
  ...
  - Post-Skinnerism/Teleological behaviorism - Human behaviors are learned, so [large groups](groups-large.md) can be measured (close to [macroeconomics](money-economics.md)).
