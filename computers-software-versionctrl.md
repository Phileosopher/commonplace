...
1. Major updates, which will make the [API](computers-programming.md) integrations no longer work the same.
...
When someone is [developing software](computers-software.md), there are a variety of reasons to make an alternative version of that software:
