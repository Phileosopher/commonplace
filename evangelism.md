...
2. We've rebelled and [sinned](morality-sins.md) against God, and are separated from Him.
3. The only [justice](morality-justice.md) we deserve is death, and that's the eventual state of this world.
4. God loves us so much that He sent Jesus ([who is God](god.md)) to die for us.
...
- Many of them believe a few possible delusions:
  ...
  - [Sin](morality-sins.md) is simply a perception, and doesn't exist, or doesn't apply.
