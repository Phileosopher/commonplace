...
- If your situation is going terribly, you may just be [sad](mind-feelings-sadness.md).
...
There are only 3 possible ways to move ourselves out of meaninglessness:

1. Doing or [creating](creations.md) something that yields a meaningful [result](results.md).
2. Experiencing something or encountering someone (i.e., some form of [love](people-love.md)).
3. We see a fate we can't change, and make the best of it by rising above it to [change](people-changes.md) into something different and better than who we were.

While most people won't tell you (since it's [taboo](morality-taboo.md) or may throw you into further depression), depression is a very selfish state of mind.
...
You can't dismiss your circumstances and "carry on".

- If you don't pay attention, you'll eventually be one unfortunate event away from committing suicide.

When we face any crisis of meaning, we increase our risk for antisocial behavior.

- Suicide is easy to conclude if we go through enough depression without any resolution.
- However, in our misery, we can more easily convert that hopeless into [aggression](mind-feelings-anger.md) and potentially homicide.
- Further, every [addiction](addiction.md) is more tempting because it gives us a temporary escape from our misery.
