...
- Compilers are a one-time translation of [high-level code](computers-programming.md) into [assembly code](computers-programming-assembly.md). They're typically time-intensive at the beginning, then run quickly afterward.
