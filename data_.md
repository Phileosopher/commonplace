...
4. The numerical values can be manipulated, expressed, transferred, and whatever else that the computer is [programmed](computers-programming-basics.md) to do.
...
- Refs (short for references) are pointing to other things such as [memory](computers-memory.md) locations, [variables](computers-programming-basics.md), or [network locations](networks-computer.md).
...
2. Do further logical things with it, based on what a [program](computers-programming-basics.md) is instructed to do.
