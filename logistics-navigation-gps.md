...
- At scale, the map information will be spread across a [distributed system](cs-distsys.md), meaning the developers have to think ahead about bandwidth and processor load relative to users' use of the software.
...
- If a map system ever integrates with [autonomous vehicles](cs-autos.md), the complexities become almost inhumanly difficult to fully codify in a single essay.
