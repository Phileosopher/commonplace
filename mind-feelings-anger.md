...
Anger is an emotional belief of a [perceived](people-image-why.md) sense of [injustice](morality-justice.md), which requires several beliefs at once:

1. Belief of [loss](hardship.md) or perceived loss, which would typically provoke [fear](mind-feelings-fear.md) or [sadness](mind-feelings-sadness.md).
...
Anger is defined by a desire for control, and broadly expresses in different forms:

1. Passive (e.g., procrastination, sulking, avoidance)
2. Aggressive (e.g., physical outbursts, bullying, violence)
3. Assertive (standing up for [rights](people-boundaries-why.md) without infringing others' rights)

Anger is *very* useful to get things done, but it ruins our finesse. [Healthy boundaries](people-boundaries-why.md) require proper use of anger.
...
- We experience [boundaries](people-boundaries.md) violated by others or [haven't forgiven a prior experience](hardship-forgiveness.md) of bad boundaries.
- We feel [guilt or shame](mind-feelings-shame.md) or are experiencing [trauma](hardship-ptsd.md) from past guilt or shame.
...
- Heart rate will elevate, breathing will intensify, and we may start sweating.
- Our muscles will tighten, especially around the jaw and arms.
- We will experience a sensation of pressure building in our head and face.

## Awareness and anger

We must learn [self-awareness](mind-awareness.md) about the [triggers](habits.md) that make us angry.

- Mindfulness helps us to slow down our reactions.
  - The slowing effect creates distance from our experiences and helps us track events as they arise.
- If we don't, we will typically react inappropriately with our anger.
- Often, we dwell on something over and over without realizing it ("rumination")
- By increasing emotional awareness, we overall reduce our [stress](mind-feelings-happiness-stress.md), which halts rumination and reactive patterns.

Anger is always connected with suffering, and there are many common triggers for anger:

- Perceived disrespect
- Unmet needs, which represent a threat to [safety](safety.md)
- [Grief](mind-feelings-sadness.md) and [loss](hardship.md)
- [Goals](success-3_goals.md) that have been blocked
...
3. In the presence of others, practice quick [meditation](mind-awareness-meditation.md) about breath awareness to distract from triggering observations.
4. The new [decisions](mind-decisions.md) foster better [habits](habits.md) over time.

Sometimes, we can take action instead of noting the things that make us angry.

- "Letting off steam" is simply adding anger onto anger, and doesn't work to resolve anything.
- However, we can often use "venting" for years or *decades* to cope with anger because it gives the [illusion](people-image-why.md) of [creating results](results.md).

## Chronic anger

Frequent anger can have a negative effect on our mental and physical health.

- Even if we suppress it, the effects still express in our minds and bodies.
