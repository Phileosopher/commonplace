...
A repository of my public commonplacing. It has emerged as a realization that my original vision for [adequate.life](https://adequate.life/), [gainedin.site](https://gainedin.site/), [notageni.us](https://notageni.us/), [theologos.site](https://theologos.site/), and [trendless.tech](https://trendless.tech/) have been misguided, especially with the new trend of the arcanely verbose plagiarism generator we call "machine learning".

So far, my first task is to simply migrate everything off those websites. That way, I can free up the websites for modifying into something more meaningful while keeping my commonplacing around for my own reference.
