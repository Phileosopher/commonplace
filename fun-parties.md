...
You can succeed at a party, even with very little skill, if you're [generally satisfied with life](happiness.md), [somewhat organized](organization.md) enough to take advantage of a venue, have some skill at defusing [major group conflicts](people-5_conflicts.md), and (if it's a large party) can [direct people](mgmt-6_morale.md).
