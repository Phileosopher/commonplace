...
Parties should be [fun](fun.md), and a party is *always* worth it if people [enjoy themselves](happiness-perma.md).

You can succeed at a party, even with very little skill, if you're [generally satisfied with life](happiness.md), [somewhat organized](organization.md) enough to take advantage of a venue, have some skill at defusing [major group conflicts](people-conflicts.md), and (if it's a large party) can [direct people](mgmt-6_morale.md).
