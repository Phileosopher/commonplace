...
- Refs (short for references) are pointing to other things such as [memory](computers-memory.md) locations, [variables](computers-programming.md), or [network locations](computers-networks.md).
...
3. Output the information somewhere. It may be nearby (e.g., a [screen](engineering-screen.md)) or sent out to another computer via a [network](computers-networks.md).
