...
TCP - transmission control protocol, the [Transport-level](computers-networks.md) standard for sending high-quality information across a network, in contrast with UDP
...
UDP - user datagram protocol, the [Transport-level](computers-networks.md) standard for sending information rapidly across a network, contrast to TCP
