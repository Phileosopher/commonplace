...
# How to tell when your tech job sucks

[The tech industry's culture](https://trendless.tech/trends/) means more tech managers are comparably young compared to other industries, which means [managerial](mgmt-1_why.md) dysfunction is far more normative than other industries:
...
- The company culture deters practices that make a healthy [work-life balance](mind-feelings-happiness.md), such as remote work for completely non-social roles or forbidding internet access at the workplace.
- The management obsesses over [political values](politics-conservativeliberal.md) that don't match yours.
- You seem not to meet all the performance metrics, even when you're devoting everything you have to the work.
...
There are some clear warning signs, though, that you may be working for a [universally bad company](mgmt-badsystems.md). The following are real stories, but to protect reputations and [not get sued](legal-safety.md) I haven't added citations.
...
- You only do 2-4 hours a week of actual work, and the rest of the time is (typically) filled with meetings.
  ...
  - You have no incentive to do more than the bare minimum or barely better than everyone else.
- Your workplace is filled with inexperienced or young coworkers.
...
- You're [lying](people-lying.md) or expected to lie about how much work you actually do.
...
- The company doesn't have much money for supplies, infrastructure, and pay raises, but upper-tier [management](mgmt-1_why.md) lives lavishly.
  - Sometimes, this can come through reducing the quality of benefits, such as requiring [healthcare](money-insurance.md) costs entirely out-of-pocket.
...
The culture of large tech companies typically abuses the intelligence and work ethic of young tech people who haven't learned self-respect yet. Many of them can endure *tremendous* misuse of their time, energy, and [intellectual property](legal-ip.md) before they realize they're worth more than a company is paying them.
...
- Ironically, it means the most [meaningful](meaning.md) work arises when times are tough, meaning every manager is closely scrutinizing how pay directs to results and only developers who have skills in the craft are working in that domain.
- The work's usefulness is also dependent on the [designated purpose](purpose.md) of the organization's leadership. Since that may move around, job security isn't usually as strong as many workers are led to believe, *especially* [when the tech is trending](https://trendless.tech/trends/).
...
- We find [meaning](meaning.md) in responsibility, so persevering against severe hardships can give us a tremendous sense of accomplishment.
...
- Many people will work tirelessly for an oppressive company, then feel a sense of accomplishment because they're [in management](mgmt-1_why.md), and therefore slightly less oppressed.
...
In the tech industry, you will *not* be short of work if you understand mainstream technologies, so an [unknown future](unknown.md) in an unknown job is better than the known crappy job you do have.

Big tech companies fashion their culture to give tremendous benefits and luxury, but almost operate like a [very productive religion](religion.md) or a [cult](people-culture-cults.md). You may be tempted to think the entire industry runs like them, but that's simply not true:

- You'll likely find *much* more [meaning](meaning.md) in smaller (i.e., <~20 employees) and mid-size (i.e., ~20-150 employees) tech companies, where your contributions will actually matter.
- If you want your contributions to *really* matter, pursue a tech role in a non-tech company. For example, IT support is relatively low-skill compared to working for a big tech company, but [accountants](money-accounting.md) and [sales](marketing.md) staff will actually *care* you fixed their driver conflict or file sync problem. The only downside is that [management](mgmt-1_why.md) will always regard you as a cost center, and therefore not always necessary.
- If you can secure remote work, you're often able to pace yourself as fast or slow as you want to go, meaning it's *much* easier to attain a [healthy work/life balance](mind-feelings-happiness.md).
