...
- On the other hand, a computer assigned to the task can often produce exponentially more than a human, but takes more time to prepare through [robotics design](computers-robotics.md) and [software development](computers-programming-basics.md).
