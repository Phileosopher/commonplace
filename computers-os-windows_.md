...
ASP.NET was designed to expand .NET into [web apps](computers-sofware-webdev.md) by using the C# language instead of JavaScript. It has...mixed opinions. On one side, it's trying to create a fire-and-forget set of solutions, but particularly intelligent [software designers](computers-software-design.md) will find it irritating.
