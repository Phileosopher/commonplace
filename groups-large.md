...
1. Legal entity: It's a separate existence which makes its own collective [decisions](people-decisions.md), though its [civil rights](people-boundaries-why.md) are generally treated as sub-human.
...
More [cultures](people-culture.md) can resonate with an organization that promotes very fewer [values](values.md), so an organization grows proportionally to how few values it conveys, assuming it has [mass exposure](marketing.md). At the same time, many values allow a clearer group [identity](identity.md). At the same time, stated values that aren't shown can cause the entire culture to [backfire](mgmt-badsystems.md) and [break apart](people-conflicts-war-why.md).
...
Middle leaders (e.g., middle management) are effectively an extension of their top leadership to manage the bottom leadership. Middle leadership often makes very few [decisions](people-decisions.md) compared to the top and bottom leadership. However, their [willingness](purpose.md) to comply with the organization's [policies](people-rules.md) keeps the entire organization unified in [purpose](purpose.md) (or, at least, the [appearance](people-image-why.md) of it). In practice, most middle management is simply the above-stated "connecting-point" to other subgroups.
...
Top leaders only have limited [influence](power-influence.md) over the entire group's [culture](people-culture.md). They only maintain it by making specific [decisions](people-decisions.md) that craft an [image](people-image-why.md) for everyone to interpret for themselves. That image promotes collective [values](values.md) (at least in [appearance](people-image-why.md)) that everyone holds to:
...
When a [bad system](mgmt-badsystems.md) starts socially engineering, they're often operating off [theories](imagination.md) mixed with trial-and-error. This can be utterly disastrous, and often leads to [social unrest](people-conflicts-war-why.md), people losing property, and people dying.
...
Every single [result](results.md) of an organization is [created](creations.md) by the members' [decisions](people-decisions.md) and actions. Thus, even when the leaders get *all* the [credit](people-image-why.md), or it had a debatable [morality](morality.md), every member was partly responsible for it, no matter how small.
...
*Many* [intergroup conflicts](people-conflicts-war-why.md) can adapt and [change groups](trends.md). This change can be surprisingly fast or only change its [external image](people-image-why.md), depending on how the leadership handles it. Since there's so much power in a group, they tend to persist indefinitely in some form or another unless they're destroyed or merged into another group.
