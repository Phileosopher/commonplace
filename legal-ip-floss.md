...
There are several non-copyright ways to release non-code text (including [technical documentation](documentation-technical.md)) with a more free license:
...
Building a personal or closed-source company project into an open-source one doesn't take *too* much [documentation](documentation-technical-cs.md):
