...
Good coders don't just sit down and type out code without knowing what they're doing. They're trying to accomplish something with a variety of [computer-based tools](https://github.com/philosaccounting/toolbox) at their disposal.
...
- Adopting an odd [keyboard](cs-keyboard.md) or [mouse](cs-mouse.md) that maximizes ergonomics.
- Getting *extremely* high-resolution [computer screens](engineering-screen.md).
- Disabling features in the operating system, or simply downgrading the entire operating system to a lower set of features (e.g., [command line](cs-cli.md)-based).
- Using a less visually-appealing [IDE](cs-software-ide.md) that's more keyboard-based.
...
For that reason, programmers have to accept they'll only get things that work well, but are never perfect. Later, they can [always optimize](cs-software-redesign.md), but getting an alpha out is the hardest challenge, and [version 1.0](cs-software-versionctrl.md) is typically a much more grandiose vision.
