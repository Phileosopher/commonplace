...
The *only* advantage a large company has over a small one is that it can do the same thing over and over at scale.

- In smaller companies, the founder is typically involved in a far greater percentage of customer interactions, meaning better [customer service](people-customerservice.md).
...
- The product of all of this is that smaller companies, run correctly, can often make *much* more profit proportionally than larger companies performing the same service.

Smaller also means more freedom for the founder.

- They can tell the truth on their blog without as much fear of a [PR](marketing.md) nightmare.
- The founder is typically outsourcing boring and low-impact things (e.g., [manufacturing](engineering.md), [logistics](logistics.md), [billing](money-accounting.md)).
...
1. Its core market will be taken over by people more competent or efficient than you and your business will eventually fail.
...
- It's a precariously dangerous place to be, since *any* increase in work (e.g., extra project needs, more work required than expected, contract renegotiation) can push you into a cascade of failing to fulfill obligations sequentially one after the other.
...
- Use software or download forms.
  - Do *not* simply edit another company's handbook, or you may be legally forced to do something against your will later.
...
Educate yourself on the following conditions for your region:
...
Since you're trading flexibility for power, start making [marketing strategies](marketing.md) ahead of time, with planned release dates for changes.

## Delegating

When you're ready to start handing off roles, learn [how to manage others correctly](mgmt-1_why.md).

- Eventually, of the company grows, you're guaranteed to become an executive unless you start selling off business units or staying smaller.
...
You may have [an amazing business idea](entrepreneur-2_idea.md), and may have even been working it as a [side hustle](entrepreneur-4_freelancing.md), but how do you prove that this thing will make enough money that someone would want to invest?
