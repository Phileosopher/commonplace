...
[Writing](language-writing.md) formed by intelligent people can be complex, but bad teachers weaponize academic writing to make it inaccessible.

- Healthy intelligent writing slowly unveils truths, often with a consideration for [artistic conveyance](art.md) or to allow even unintelligent readers to slowly grasp a concept.
- Without an intent to [communicate](language-writing-messages.md), the information will be difficult to read, even for [very smart people](mind-neurodivergence.md).
...
A bad educational system can be toxic to its students:

- Committing random information to memory without a desire behind it only [clutters](organization.md) the mind, and the only students who survive it have a strong [purpose](purpose.md) that sits *outside* that bad educational system.
- Many teachers simply make up grades.
