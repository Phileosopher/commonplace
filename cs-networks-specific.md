...
AdGuard (*very* effective at blocking ads) default servers:
...
Adguard family servers (blocks more filth):
...
Cloudflare (highly reliable, since it runs most of the internet)

- 1.1.1.1
- 2606:4700:4700::1111

Quad9 (a great, lesser-known fallback)

- 9.9.9.9
- 2620:fe::fe

Quick copy-paste of the above:
...
- unsecured, [botnets](cs-infosec-pentest.md) use it for spam, use port 587 instead
...
- vulnerable to [DDoS attacks](cs-infosec-pentest.md)
...
### [Authentication](cs-infosec-authentication.md) ports
