...
4. If you're working on a [large-scale system](computers-distsys-enterprise.md) like a web server or a very tiny system like a [Raspberry Pi](computers-embedded.md), extra [graphics](engineering-graphics.md) can be clunky and slow everything down, and can be another possible thing that could break down.
