...
Rolling release - a version control philosophy where new versions of a software are automatically updated to all computers that had a previous version
...
SMS - simple messaging system, a very standard protocol for phone text messages
...
Sound card - dedicated memory, CPU, and rear ports specifically for [sound processing](engineering-audio.md), is typically baked into the motherboard but can still be a PCI extension for audio professionals

SPA - single page app, a simple website/app that's only 1 page of content

Spam email - unsolicited email sent to someone
...
State management - a programming language managing states
...
String literal - the actual text typed into source code

String value - the text outputted from source code
...
Switch - a network box that operates as a type of [demultiplexer](cs-alu.md) to direct signals to their destination, in contrast with a hub

Symbolic link - aka symlink, a file that names another file, contrast with hard link
