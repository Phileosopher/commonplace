...
For every manager, communication is your priority.
...
- It may be tempting to send a message without expecting a response, but that sets up miscommunication.
  - People often receive messages, then forget them or forget to act on them.
  - While you may be annoying people by ensuring they've read it, it's the only way to work with how easily distracted we get.
...
- If you *had* given any previous commands, override them with the current ones.
  - If it was from the authority of someone else, make sure to talk to *that* authority to prevent any future discrepancies.
...
In particular, [meetings](mgmt-5_communication-meetings.md) require their own section.
...
- If any important information does show up, save it to a more accessible location.
...
- Since your opinion determines their job security, you will *always* have more authority than them.
- Treat that as a responsibility to respect them more from your position of [power](power.md).
...
- It's not uncommon for information to become outdated, which will cause *major* misunderstandings later if you don't terminate the knowledge base.
...
People find [meaning in responsibility](meaning.md), so correctly delegating tasks correctly grants *tremendous* meaning to everyone.
...
- More time thinking on correct policy and procedure allows you to more clearly [understand](mind-understanding.md) the best way to frame the language in the documentation.

Making procedures themselves is an ongoing process of [technical documentation](language-writing-documentation.md)
...
Without an ombudsman, the gaps in expertise will likely be filled by [technical idiots](https://gainedin.site/idiot/) that [fix problems](https://adequate.life/fix/) that may not need fixing, or that won't resolve the actual problem the user is having.
...
For it to work, however, the work *can't* be on-site.
...
- You can often compromise a hybrid on-site/off-site team if you can heavily divide the work roles.
...
- If you can't be present, drive performance strictly on data.

Their work-from-home site is still their home, so respect their privacy.
