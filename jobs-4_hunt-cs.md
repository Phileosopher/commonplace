...
# How to hunt for jobs in the tech industry

All [the general rules about job-searching](jobs-4_hunt.md) apply completely in tech, though it's a bit more about creating and less about networking.
...
[Going to college](jobs-college.md) isn't usually a *bad* idea (especially if it's a tech-related major like Computer Science), but the degree itself isn't very useful nearly as much as the networking opportunities and formalized education that evenly covers all the necessary topics.
...
For this reason, the tech recruiting industry is filled with a barely-fluent army of low-skilled people working a get-rich-quick scheme (not completely unlike [MLM](marketing-mlm.md)). While some recruiters *do* stand out (and are worth [connecting with](jobs-5_interview-cs.md) long-term), it creates a few symptoms:
...
- **Outright [lying](people-lying.md) about a role being remote, permanent, benefits, etc.** - carefully examine the employment agreement you sign, and block the recruiter's number if they've lied.
...
You do need to keep your social media profiles up-to-date with your accomplishments, but try to avoid anything technical on LinkedIn. That social media site has so much [#successporn](success-1_why.md) that it takes away from anything [meaningful](meaning.md) you can do in the tech world.
...
Having [the right attitude](success-2_attitude.md) makes all the difference in the world, especially when you get that call. From there, you're going to have a battery of [technical interviews](jobs-5_interview-technical.md) and [dialogue with a hiring manager or three](jobs-5_interview-cs.md).
