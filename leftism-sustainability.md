...
The justice of a society hangs heavily on its [culture](culture.md). A [good society](politics-perfectsociety.md) requires a culture driven on aspects of [love for each other](people-love.md). Otherwise, it requires [fair](morality-justice.md) and well-enforced [laws](rules.md).
