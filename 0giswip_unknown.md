...
Our minds naturally repel chaos and strive for order when we [perceive](image.md), but this is often impossible from the inherent state of nature. Anytime we develop "two" things instead of "one", it forms some degree of unknown by the strict necessity of our need to [divide it](logic.md).

While it's not inherently obvious, we find [meaning](meaning.md) in making order out of chaos, proportionally to our [openness to experience](personality.md). Complete order is boring to us, and complete chaos overwhelms us, so there's always a balance that leads to [living correctly](goodlife.md).

[Nature itself](reality.md) is inherently chaotic, with a semi-maintained semblance of order contained within it (e.g., how rivers form). We, in [our humanity](humanity.md), are the opposite: inherently ordered, with a semi-deconstructed chaotic element contained within it.
...
We tend to demarcate between "man-made" and "natural" by how much order we interpret something to have. A rock is natural, but a statue is man-made. However, everything possesses some base sense of order behind all the chaos, as [science](science.md) can demonstrate.
...
Tend to be [poor](classes.md) or [uneducated](pedagogy.md)

Seeks instant gratification, lower grades in [school](pedagogy.md)
...
2. The Past is the second-most known we have, proportional to how near it is to us in time and how reliable our memories are. It also represents some of the worst qualities that we need to [change](changes.md), and we run the risk of falling behind the [trends](trends.md).
...
The Unknown isn't "bad", but it's unpredictable. From our [perspective](image.md), [God and the devil](religion.md) come from the same place. However, we focus on the bad, so we [group](logic.md) it that way.

Over time, as the Unknown becomes [known](science.md), a society will prioritize the domain of [predictable](imagination.md) and [controllable](mind-creativity-results.md) things over sending [efforts](purpose.md) into unknowable things. This means secular societies who abandon their [religious](religion.md) background tend to lean farther into [environmentalism](leftism-sustainability.md) and prioritize [mathematical](math.md) [estimation](imagination.md) over [intuition](mind-feelings.md).
...
[Fear](mind-feelings-fear.md) of the Unknown is good to a point. However, we must still manage it, or it'll bury us. The easiest way to do it is through as much [education](pedagogy.md) as we can acquire on the subject, and accept what we can't know.
...
We wish to find [meaning](meaning.md) in the Unknown so heavily that we trust things we probably shouldn't:
...
- It's easy to over-apply [reasoning](logic.md) to the Unknown, which will make us overthink when it's time to [perform](mind-creativity-results.md).

More [information](information.md) isn't always better. At times, that extra information can cloud our judgment from *other* semi-aware information we would have otherwise observed.
...
Never disrespect [creations](creations.md) that ever add [value](values.md). While later creators make things that add *more* value, they required the original creator (or chain of creators) to draw from the Unknown.
...
Chaos isn't as bad as you think, even if it's absolutely [terrifying](mind-feelings-fear.md). You're in the right to be afraid, but are more capable toward [acting](mind-creativity-results.md) than you realize (and [absolutely must](meaning.md)).

The preservation of order is a natural impulse, and worth knowing to [understand](understanding.md) how others think. We must be mindful of what we destroy and what we're using to replace it, but the Unknown is where we draw our [creativity](mind-creativity.md) and where the [social risks](socialrisk.md) become highly [influential](influence.md) [trends](trends.md).

Whenever we see any disorder, our impulse is to focus on it. In reality, that disorder is built on a *ton* of previous order, which could all be destroyed if we don't observe its significance before [making decisions](decisions.md).

The best way to prepare for what [scares](mind-feelings-fear.md) us is to think *ahead* of time. [Risk management](safety-riskmgmt.md) is a premeditated action.

If you don't know and can't know, wait and watch. Eventually, you'll know. Even [whether God exists](religion.md) will become clear to us all.

We often [believe](understanding-certainty.md) our memories are pristine. However, they're open to failure and not very reliable as time passes. Thus, we should only partly trust ourselves about our perspective as a [scientific](science.md) reality, consistently [cross-reference it](people-conversation.md) with others' to be as certain as possible, and quickly change our [value system](values.md) if we find we're wrong.

The [feeling](mind-feelings.md) of betrayal is uniquely devastating to us because it's a deconstruction of the order we had imagined existed.

How we focus on the past, present, and future dictates how we prioritize the Unknown for our [purposes](purpose.md). This represents itself in the way we [choose](decisions.md) to live and [the groups we associate with](groups-member.md).
