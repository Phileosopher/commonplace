...
3. [Legally substantial](legal-lawsaxioms.md) information does *not* need arbitrary complexity and *can* be [designed](engineering-design.md) for ease-of-use, though law school takes enough work that [it makes sense to obfuscate it](mgmt-badsystems.md).
...
- **Dave** (also referred to by "I", "Me" or "My" in this Agreement) refers to Dave Stucky (also known as Greg Stucky) and the [legal fiction](legal-lawsaxioms.md) declared from his birth as GREGORY DAVID STUCKY.
