...
Your access to and use of the Service is conditioned on Your acceptance of and compliance with this Agreement. These Conditions apply to every entity who may directly or indirectly access or use the Service. Please carefully read every section of My Agreement before using My Service. Failure to read and honor this Agreement exempts me from all liability.
...
Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy section of this Agreement. My Privacy Policy section describes My policies and procedures on the collection, use and disclosure of Your Personal Data when You use the Service and tells You about Your privacy rights and how the law protects You.
...
Your usage of the Service provies an implicit belief that both You and I are acting in good faith. Your failure to act in good faith exempts me from any liability You may incur while using the Service.
...
2. Achieve any intended results
3. Be compatible or work with any other software, applications, systems or services
4. Operate without interruption
5. Meet any standards of availability, operation, performance, accuracy, reliability, or currency
6. Be error free
7. That any errors or defects can or will be corrected
8. Be free of harmful components such as:
   - Viruses
   - Scripts
   - Trojan horses
   - Worms
...
1. I shall not be responsible or liable, directly or indirectly, for...
2. ...any damage or loss caused or alleged to be caused by...
3. ...or in connection with the use of or reliance on...
4. ...any such content, goods or services available...
5. ...on or through any such sites or services.
...
1. The amount directly paid by You through the Service.
2. 100 USD if You haven't purchased anything through the Service.
...
- For United States compliance, You represent and warrant the following:
  1. You are not located in a country subject to a United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country.
...
The Service uses Your personal data to provide and improve the service. By using the Service, you agree to the collection and use of information in accordance with this Privacy Policy section.
...
- **Comments on any social media or blog post:** An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service privacy policy is available here: <https://automattic.com/privacy/>. After approval of your comment, your profile picture is visible to the public in the context of your comment.
...
You may also have the option of sharing additional information with Me through Your Third-Party Social Media Service's account. If You choose to provide such information and Personal Data, during registration or otherwise, You are giving Me permission to use, share, and store it in a manner consistent with this Privacy Policy section.
...
- **Cookies or Browser Cookies.** A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or indicate when a Cookie is sent. However, if You do not accept Cookies, You may not be able to use some parts of My Service. Unless you have adjusted Your browser setting to refuse Cookies, My Service may use Cookies.
...
- **With Affiliates:** I may share Your information with My Affiliates, in which case we will require those Affiliates to honor this Privacy Policy section. Affiliates include My parent company and any other subsidiaries, joint venture partners or other companies I control or that are under common control with Me.
...
I will retain Your Personal Data for only as long as is necessary for the purposes set out in this Privacy Policy section. I will retain and use Your Personal Data to the extent necessary to comply with:
...
I will take all steps reasonably necessary to ensure Your Personal Data is treated securely and in accordance with this Privacy Policy section. Your Personal Data will not transfer to an organization or a country unless there are adequate controls in place that protect the security of Your data and other Personal Data.
...
If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by directly contacting Me. While I make no promises to the specificity of the response, I promise I will engage and respond in a reasonable manner and in good faith.

If you cannot document an interaction with Me, You cannot engage in a formal action against Me.
...
If you have any questions about My Agreement, please contact Me by email: <dave@stucky.tech>
