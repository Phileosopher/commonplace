...
Leaders can also adapt [language](language.md) to represent the people paranoid about conspiracies as [fringe](people-trends.md) believers, then destroy their [credibility](people-image-why.md) in the process (e.g., saying those people are [conspiracy theorists](politics-conspiracy.md)). In response, many of those people will often feed into their [fears](mind-feelings-fear.md) and reinforce unhealthy [bias](mind-bias.md) in their [stories](stories-why.md), further destroying their credibility.

Often, those minority views will be [portrayed](people-image-why.md) as the [martyrs of the trend](people-trends.md). This doesn't mean those people were necessarily [noble](morality.md), though. Those people were often [fairly](morality-justice.md) outmaneuvered by someone who out-succeeded them. Other times, they simply had a very confrontational [personality](people-personality.md) against *any* [authority figure](people-rules.md).

Sometimes, particularly clever leaders will pit [smaller groups](groups-small.md) against each other. Their in-fighting will destroy any chance they could have to confront their shared opponent. In that context, the larger group leader can then portray [shame](mind-feelings-shame.md) toward anyone who isn't accepted by that leader by implying the smaller groups are "on the wrong side of history" or "not working hard enough to succeed".

Smaller groups *do* have [options to fight back](people-conflicts-war-why.md), but require [creative](mind-creativity.md) and unconventional [risks](entrepreneur-why.md) that often carry [unknown dangers](unknown.md), which typically can only succeed *outside* that large group's [influence](influence.md). And, even without direct control, large enough monopolies can usually find a way to make almost any activity profit them or prevent smaller opponents from succeeding.
...
For the most part, the bad systems which survive will swear fealty to whatever greater power is present. This is a selfish attempt to [distort their appearance](people-image-distortion.md) as weaker than they really are.
