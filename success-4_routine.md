...
- The smaller the task, the simpler it is, and the easier it is to optimize.
  - If you have any [computers](computers.md) or [robotics](cs-robotics.md), it's *much* easier to [program](cs-langs.md) as well.
...
- You're working in a familiar environment, so it might be less stressful, but only if you don't have [children](parenting-children.md) or a [spouse](relationships-marriage.md) interfering with your flow.
