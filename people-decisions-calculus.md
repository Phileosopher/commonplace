...
APPLICATION: Our risk-averse tendencies create a type of social order (since only [innovators and early adopters](trends.md) will [risk everything](socialrisk.md)), and it means taking larger risks can yield *dramatically* larger results because nobody else is reaping those benefits.
...
We need certainty proportionally to the scope of the [consequences](results.md) we [predict](imagination.md) for a decision. Choosing a hamburger or chicken sandwich is merely a matter of [preference](people-decisions.md), but choosing to [change jobs](jobs-1_why.md) or work for a promotion can affect *years* of a lifestyle.
