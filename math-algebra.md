...
Most people can intuitively understand arithmetic (2+2=4).

Algebra builds on that arithmetic, but then adds quite a bit more.
...
One of the most significant aspects of algebra is how to work with the distributive property [a (b + c) = ab + ac].

- It allows more rearranging of values, which becomes *very* useful once multiple variables are introduced.
- Philosophically, it represents the broader concept of "equivalent expressions", which is basically when two formulas are the same thing.
