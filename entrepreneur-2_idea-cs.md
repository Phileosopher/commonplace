...
The speed that computers run means that most of the limits in building your own business is mostly based on how well you can [develop software](cs-software.md), along with the ability to [keep computers running](cs-distsys-enterprise.md) for the necessary services that software needs.
...
Thus, since [all computer code can be improved](cs-software-redesign.md), tech entrepreneurship always has room for freelancers and people who are willing to explore a new way to use computers.
