...
*Previous: [Creating Projects](/mgmt-projects/)*

Unless you're taking over an existing project, you'll likely have to get a [budget](https://adequate.life/money-3/) and assemble a team.
...
2. For each task, indicate the kinds of expertise or [personality](https://gainedin.site/personality/) required for the role.
...
- The model breaks apart and independently analyzes aspects of an organization:
  - Strategy - [purposes](https://gainedin.site/purpose/) and how the organization gets to them.
  - Structure - agreed-upon organizational order.
  - Systems - informal [habits](https://gainedin.site/habits/) the group has adopted.
  - Shared Values - shared group [beliefs](understanding-certainty.md).
  - Style - the [culture](https://gainedin.site/culture/) behind everyone acting.
  - Staff - the specific members themselves and their roles.
  - Skills - qualified [specializations](https://gainedin.site/specialization-cities/) of the members.

Create an organizational chart.

- Define the necessary, specific details for each role:
  1. The direct responsibilities.
  2. Natural [personality](https://gainedin.site/personality/) strengths those responsibilities would require.
...
1. Acquisition - growing and getting more (sales, [marketing](/marketing/), business development, etc.)
2. Delivery - getting things to where they need to be ([logistics](/logistics/), customer support, etc.)
3. Development - improving the outputs (product development, [engineering](/engineering/), [maintenance](/fix/), [programming](https://trendless.tech/prog-basics/), etc.)
4. Operations - broadly supporting the organization ([finance](/accounting/), [HR](/business/), [IT](https://trendless.tech/fix), recruiting, etc.)

Create a budget for each role:

1. The expected wage for each role.
2. Secondary costs attached to the role ([taxes](/accounting/), filing fees, required certifications, etc.).
3. [Advertising](/marketing/) and recruiting costs (job board, recruiter commission, etc.).
...
- Going past a team consisting of a few people guarantees multiple problems at once:
  - [Communicating](/mgmt-communication/) to everyone at once becomes complex and time-consuming.
  - People won't feel like their contribution means much, so some members won't do much.
  - There will be unavoidable [personality](https://gainedin.site/personality/) [conflicts](https://adequate.life/conflicts/), *especially* when trying to achieve group consensus.
  - The [corporate culture](https://gainedin.site/groups-small/) of large groups tends to generate enough [peer pressure](https://gainedin.site/influence/) that everyone will be more likely to resist [change](https://gainedin.site/changes/).
...
- To avoid [technical idiocy](/idiot/), try giving associated tasks that demonstrate the consequences or inputs of their dominant role (e.g., sales staff also makes a few followup calls).

Belbin Team Roles:

- Helps define roles into 9 domains based on comparative [personality](https://gainedin.site/personality/) assessments:
  - Thought-Oriented
    - Monitor Evaluator - fact-based decision-maker
    - Specialist - niche understanding of technical facts, often serves as an advisor
    - Plant - [creative](https://gainedin.site/creativity/) idea-maker, often works alone
  - Action-Oriented
  ...
  - People-Oriented
    ...
    - Team Worker - effective [listener and communicator](https://adequate.life/speaking/) who seeks group harmony
...
- Even if you're working informally with others you know personally beforehand, a job description clarifies expectations.
  - It's a lightly enforceable [contract](/contracts/) that keeps the manager safe from misunderstood expectations and the subordinate safe from coercion or abuse.
...
- **Job title and duration** - the actual name of the role.
  ...
  - While [title inflation](/marketing/) isn't uncommon, the roles should have a relationship to other roles.
...
- **Benefits and pay** - the aspects of what you're providing in exchange for their work.
  ...
  - If they're particularly talented, they will likely [negotiate more](https://adequate.life/jobs-6/) than you expected.
...
- **Requirements** - pre-existing conditions the applicant should have.
  ...
  - Indicate any cultural/attitude [personality](https://gainedin.site/personality/) requirements as well.
...
1. Via network, among the people you know.
   - Gives the least opportunities, but can create a more well-adjusted team because people like to [associate](https://gainedin.site/friendship/) with others who are like them.
...
3. Delegated to a placement agency.
   ...
   - It adds another party to the arrangement, which can make the hiring process more complicated (e.g., constraints from the [right to represent](/contracts/)).

Focus on growth, impact, and care when [marketing](/marketing/) the job:

1. Growth is essential for everyone's career self-interest, especially for young workers.
2. Impact is critical to give [meaning](https://gainedin.site/meaning/) to the work, especially for younger workers.
...
- Use [personality](https://gainedin.site/personality/) tests to clearly demarcate what kind of person they are before you hire them.
- Unless it's *highly* specialized, focus more on motivation than skill.

## Deciding

Consider your own [personality](https://gainedin.site/personality/) when hiring.
...
- If you find workers who are more [creative](https://gainedin.site/creativity/) or [intelligent](understanding.md) than you, expect them to frequently prove you wrong.
- If you know someone will work harder than you, make sure they'll be well-paid (and possibly more well-paid than you).

While every potential candidate *could* do the job, aim for a [culture](https://gainedin.site/culture/) fit.

- A diverse range of demographics ([age](https://gainedin.site/maturity/), [gender](https://gainedin.site/gender/), [family composition](https://gainedin.site/family/), [political views](https://gainedin.site/conservative-liberal/)) is guaranteed to generate more [creative solutions](https://gainedin.site/creativity/), but at the risk of more [conflicts](https://adequate.life/conflicts/).
...
- However, if it's a new team, it'll take a bit more work to assign roles for everyone, since [conventions](https://gainedin.site/culture/) haven't been established yet.
...
- Group harmony with each other comes through everyone's shared [identity](https://gainedin.site/identity/), but group harmony *outside* the organization comes through how many demographics and contrasting [value systems](https://gainedin.site/philosophy/) are represented inside that group.
...
- However, in practice someone is simply getting paid to learn, but with a *very* distracted [teacher](https://gainedin.site/pedagogy/).
...
- [Distrust](https://gainedin.site/trust/) is contagious.
...
- They're re-creating [personal family roles](https://gainedin.site/family/) and subconsciously drawing out others' unhealthy behaviors.
- They feel inadequate in their private life, so they seek revenge through their work.
- They believe they'll find [meaning](https://gainedin.site/meaning/) or [solutions](https://gainedin.site/purpose/) to their problems by controlling things beyond themselves.
...
- You may need to micromanage a low-skill team (e.g., fast food, construction), but [legitimate professionals](/professionals/) should *never* be disrespected over their free decisions.

The [personality disposition of a manager](/mgmt/) means you may easily err in overstepping your boundaries:

- Giving mandatory time for breaks, even when the work doesn't need people to work together or synchronize schedules.
- Asking for constant status updates, even when the work is hard to measure (e.g., [tech management](https://trendless.tech/mgmt/)).
...
- If someone is under-performing they might have an attitude problem, but it may also be a [cultural](https://gainedin.site/culture/) misunderstanding.
...
- The role's needs and [personality](https://gainedin.site/personality/) of the person don't match.
- After repeated admonitions and warnings, they're not improving.
- Consistently disrespects and subverts the workplace culture.
- [Technology](https://gainedin.site/technology/) or industry changes has made their role no longer necessary.
...
- Some people have bad days or [toxic arguments](https://adequate.life/conflicts/), but one event alone is rarely enough that you should outright terminate their role.
- If that worker has a [family](https://gainedin.site/family/), your termination will impact those people as well.
- Unless that person is completely unproductive, firing and rehiring for the role is typically more resource-intensive than [giving that person more motivation to work](/mgmt-morale/).

Barring truly awful human behavior, you should *never* [want](https://gainedin.site/purpose/) for them to quit, but instead for them to [change](https://gainedin.site/changes/).
...
- Damaged [reputation](https://gainedin.site/image/) of the team and organization.
...
Firing the wrong way will create *severe* [legal risks](/legally-safe/).
...
If you keep letting go of qualified workers after projects terminate, consider a [project-based](/mgmt-projects/) hiring arrangement for future hires.

*Next: [Project Status & Cycles](/mgmt-status/)*
