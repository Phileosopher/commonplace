...
CAPTCHA - Completely Automated Public Turing test to tell Computers and Humans Apart, increases in complexity with machine learning
...
Cursor - An indicator to show where the user input is pointing to on a screen, tends to angle rightward because [expectations](mind-imagination.md) are difficult to break

Cyberattack - using the internet to damage someone else's computer system or take their information

Cyberespionage - subversive computer activity against an institution

Cyberterrorism - using computers to evoke public or government-targeted FUD
...
Desktop environment - a group of GUI elements that allow a user to run most applications on an OS
...
Disaster - a bad thing that happened and destroyed an IT asset

Disaster recovery - restoring computer systems after a disaster

Disaster recovery plan - the plan for disaster recovery
...
Encryption - the state of being encrypted

Encryption key - the piece of information that decodes something encrypted
