...
The art of working with the public involves many small details of [tact](https://adequate.life/people-3/), but adds behaviors that make the consumer feel important.

- One rude clerk will completely offset *hundreds* of well-placed and well-framed [advertisements](/marketing/).
...
- With computers, the easiest system for keeping track of customers is often as a [database](https://trendless.tech/database/) with employee-specific [permissions](https://trendless.tech/authentication/).
...
1. Problem-focused creates challenges if there's a long-term relationship with the customer (i.e., where issues are resolved, then arise again with no knowledge of former issues).
   - This isn't usually an issue, but can make [break-fix](/fix/) difficult.
...
- No matter what, everyone must make sure they leave sufficient [documentation](/documentation/) about what happened, with a focus on how the past events may influence future interactions.
...
Most [conflict management skills](https://adequate.life/conflicts/) that assert a win/win are *not* useful in most customer service capacities.
...
Whenever possible, stay [legally safe](/legally-safe/) by keeping a record of what was said, promised, and performed.
