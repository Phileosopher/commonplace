...
They're usually implied as entertaining [stories](stories-why.md) (and often the [basis](mind-creativity.md) of many of them), but you'll likely also see [which philosophies you believe](philosophy-glossary.md) and why [some laws are universal](philosophy-lawsaxioms.md).
...
- Prefactual - Given the present, what will happen in the future after an event happens? (effectively what we do when making most [decisions](mind-decisions.md))
...
A [game theory](math-gametheory.md) problem, but has can have moral implications, so it works here.

There is a condition that creates several situations:
...
A trolley full of your loved ones is heading down the tracks and will hit another loved one.

If you redirect it, it will hit three strangers, but all of your loved ones will be fine.

However, there is another person on the other side of the tracks facing the same problem.

If you both choose to redirect the trolleys, they'll crash in the middle and kill almost everyone.

The least amount of people will die if you do nothing and allow a loved one to die.

The best-case scenario for you will happen if you pull your lever and the other person doesn't pull theirs.

The worst-case scenario will come if you *both* pull your levers.
