...
There are [many indicators of narcissism](mind-neurodivergence-clusterb-narcissist-indicators.md), especially with [conflicts](people-conflicts-narcissist.md).

- However, it takes practice to reliably detect them in comparison with mere [selfishness](morality.md), [immaturity](maturity.md), or [other Cluster B disorders](mind-neurodivergence-clusterb.md).
- Very often, an intimate partner with extremely selfish behaviors was a borderline personality who later expressed narcissistic traits.
...
Technically, every person is born with a type of narcissism called "primary narcissism".

- Essentially, it's a delusion that we are our mothers (since an unborn baby technically is).
- However, we drop that narcissism either when we're capable to walk into the world as a separate [identity](people-identity.md), or later in adolescence when we [break free from our parents](parenting-teenagers.md).
...
- There is also a high-functioning exhibitionist narcissism, but it doesn't have a clinical diagnosis because it's technically a functioning way to live.
  - People in this domain tend to spend excessive time on [social media](networks-social.md) and [maintaining their image](people-image.md).
...
Their [philosophy](philosophy.md) and general attitude won't accommodate other viewpoints or [the unknown](unknown.md).

- Typically, our [logic](logic.md) requires us to accept things as outwardly verifiable ("problematic" or "assertoric").
  - We tend to [trust](mind-trust.md) the world around us, with only some things that are verifiable in our own mind (e.g., [math](math.md)).
- By contrast, the narcissist is unable to accept things outside themselves, so they state things as a self-contained truth ("apodictic").
  - This is because the statements are a part of their [identity](people-identity.md)
- For example, "everyone loves me" an outwardly verifiable statement, but a narcissist will see that as a truth unto itself.
...
- In that absence of love, the only thing they seek is [power](power.md), and they *constantly* monitor the dominance hierarchy to see how they can climb it.
...
- The garlic deters them because it is an ancient antiseptic, but is also a bit of a social deterrent (since garlic breath is *not* pleasant).
...
This decline would be tragic enough, but they will create complexities with others around them by [traversing through eight stages of abuse](hardship-abuse-narcissist-stages.md) with every victim willing to engage in their downward spiral.
...
Further, their inability to self-reflect means they'll never [change](people-changes.md).

- More frequently, their successes in exerting control will give them a delusion over how much control they really have over others.

However, as they start losing control, several predictable tactics will often hasten their crisis:
...
- Their allies will eventually become enemies when they hold them accountable, and then won't be available to help them later.
...
The only cure is for God to directly touch their heart, since nobody else will be able to perform the patience and kindness necessary to change the narcissist's value system.

- They essentially must learn to transplant anger for love.
- In a clinical environment, they will have to progress through many stages of therapy:
  0. Acknowledgment: a select few will accept that therapy may be advantageous
  1. Symptom relief or appeasement: most of them will look to get relief from their constant misery, but will leave as soon as they feel better or the person/group is appeased.
  2. Avoid future pain: some of them will find therapy more interesting than they expected, and may continue long enough to understand their triggers and make a plan to avoid future pain
  3. Identify coping mechanisms: they understand and identify their primary defense patterns, which is fairly easy because they won't feel they're being judged
  4. Create new coping mechanisms: they'll open themselves up to discussing alternate strategies to meet their needs that are more constructive
  5. Form new habits: they'll be encouraged to inhibit the old narcissistic habits and integrate more pro-social behaviors
  6. Impact on other people: they usually feel so much [shame](mind-feelings-shame.md) that they can't accept their effect on others until they have new coping patterns in place, so they will be encouraged to consider other people's needs specifically in how it benefits them
  7. Focus on childhood pain: their life is generally calmer and they've learned to cope through many situations, this allows the therapy to focus on childhood pain and for them to develop a more stable and realistic image of themselves
  8. Update the inner voice: they are encouraged to visit the early childhood "scripts" they haven't updated and give more accurate updates to it
  9. Empathy for other people: once they understand and have come to terms with their own pain, they can start looking at others' pain
  10. Authenticity: they feel safe to share their "bad side" because they know they are safe from judgment

More abstractly, the solution requires several stages:
...
Since this is a self-discovery, they may need to experience tremendous [hardship](hardship.md) from their own consequences to come to their realization.

- Even then, their repentance may only be a [fear of death](hardship-death.md) or [consequences](results.md).

Most NPD will die without treatment, since any form of psychological treatment for NPD is, by its nature, [anathema](morality-taboo.md) to a narcissist.

- Most of the time, they will be diagnosed due to [incarceration](hardship-incarceration.md) or other legal context that requires it.
...
- This is not likely, though, and [it's better to move on](hardship-abuse-narcissist.md) if they're in your life.
