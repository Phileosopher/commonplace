...
- Content Managers: [write and proofread](language-writing.md) content all day
  - Social Media Manager: monitor and create [social media](computers-networks-social.md) content all day
  - SEO: obsesses about [keyword optimization](marketing-seo.md)
- Growth Hackers: runs reports on marketing numbers and finds ways to [make companies scale](mgmt-7_changes.md)
  - Developer Relations (DevRel): a more human-relatable growth hacker
...
- User Acceptance: tracks the users' acceptance of any changes
...
- Back-End Developer and Server-Side Developer: make stuff for front-end developers ([databases](database.md), [APIs](computers-programming-features.md), [core logic](logic-cs.md))
  - Backend Engineer: focuses on all aspects of back-end systems
- Software Developer: creates [software](computers-software.md)
...
- Full-Stack Developer: can do both front-end and back-end development
  - [DevOps](mgmt-2_projects-theories.md) Engineer: can oversee a software project entirely from front to back
  - Game Developer: designs [games](computers-software-gamedev.md)
- AR/VR Engineer: designs [VR-based implementations](computers-xr.md)
...
[Protecting things](computers-infosec-compliance.md) (for those who prefer [enhancing safety](safety.md)):
...
- Cybersecurity Specialist: verifies that [computers are safe](computers-infosec.md)
...
- Penetration Tester: [acts like a hacker](computers-infosec-pentest.md) before the [hackers](mind-creativity-hacking.md) get to a system
...
[Managing people](mgmt-cs.md) (for people who work well with [other people](power-influence.md)):
...
- Technical Recruiter: tries to get qualified people in front of the (role) managers
  - Developer Evangelist: a recruiter for a specific company
