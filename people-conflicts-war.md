...
# The practical logistics of a large-scale conflict
...
Since information control is so critical, [journalists](language-journalism.md) are frequently weaponized before, during, and after a military conflict.

- Beforehand, the efforts are to sow fear, uncertainty, and disorder (FUD) among the enemy groups and anyone who may interfere with the host's agenda.
- During, the effort is focused on misdirection about what is really happening for the sake of provoking the enemy to misallocate their [logistics](logistics.md)
- Afterward, the effort is devoted to writing [history](stories-storytellers.md) in such a way that makes the host [look like](people-image-distortion.md) the [virtuous](morality-virtues.md) organization.

## Large vs. small: large

Larger and more powerful groups tend to assume they have an automatic victory before they start proportional to their [perceived](people-image-why.md) relative size, which is a *major* disadvantage because they underestimate their enemy.
...
Smaller groups, if [motivated](purpose.md) by an [influential](influence.md) leader, are usually *far* more determined and focused than their larger opponents. In lieu of those leaders, the group *can* consist of [determined](purpose.md) [self-leaders](success-1_why.md). However, without any leadership, the group will be motivated almost strictly by [fear](mind-feelings-fear.md) and won't make many sensible long-term strategies.
...
Often, whenever two groups are engaged, other groups who are unaffiliated with the two groups will observe the interaction. Their [decision](mind-decisions.md) will dramatically affect the conflict:

- They could simply ally outright with the group that serves their interests the most.
- They may quietly support or sabotage one group, but obscure their allegiance to allow their continued good faith with both sides.
- If they stay unaffiliated, they may serve to prolong the conflict through making economic partnerships with *both* sides.
- At any time, the group's interests will redefine their allegiance, so it's not uncommon for them to cycle between all the above at different times.
