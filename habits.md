...
A habit is anything that psychology broadly classifies as "conditioned response". Unless we're making a [conscious](humanity.md) [choice](mind-decisions.md), our behaviors are dictated by habits.
...
Habits are more powerful than mere [decisions](mind-decisions.md) because they bypass our conscious mind, which removes our [internal negotiation](people-conflicts-inner.md) from the [decision-making](mind-decisions.md) process. They are effectively the long-term way we [conform](people-changes.md) to a situation.
...
Since we're not directly conscious of most of our habits, time passes *much* more quickly when we let them run our lives. People will remember the events of their first 20 years (especially [adolescence](maturity.md)) much more than the next 30 because there are comparatively few *[new](people-image-why.md)* events that require new [decisions](mind-decisions.md).

## Adaptations

Humans are the only creatures on this planet that can stop mid-habit and question their actions and thoughts. That knowledge gives us the profound [power](power.md) to change our flow of behavior with new [decisions](mind-decisions.md).
...
However, traditions only have value to the degree they're not boring. As soon as they're boring, they're simply a mindless set of tasks to accomplish a [purpose](purpose.md). Each of our [personalities'](people-personality.md) openness to new experiences dictates how fast we get bored.
