...
# Technical documentation for computers

All the [general rules of technical documentation](language-writing-documentation.md) apply, but there are some extra quirks inside the tech industry.
