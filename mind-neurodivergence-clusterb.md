...
The process that builds Cluster B thinking is somewhat straightforward:
...
3. Reverse Victim and Offender: If the attack doesn't sufficiently suppress their victim/opponent, they will still feel unsafe. As a safety mechanism, their mind will rearrange their [memories](mind-memory.md) to indicate that *they* were the victim against the offender.

The reversals come in various forms, but tend to be successful in proportion to several factors:
