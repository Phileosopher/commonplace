...
These primitives can work into more elaborate "composite data types", which are almost a secondary "primitive" to even further uses.
...
Array sizes are permanently set when you first make them. Thus, you'll have to think ahead about how big the "dataset" will be. So, you can either make an array with the data "populated" already or leave the data blank to be filled in later.
