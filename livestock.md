...
Livestock, or animal husbandry, is *much* harder than [gardening](plants.md), with many more obligations and work required.
...
- Animals tend to excrete, then naturally walk away from it. If it's outside on raw land, the elements will convert it to high-quality [potting soil](plants.md).
...
One simple way to improve your *[agricultural](plants.md)* yield is with mob grazing or rotational grazing, which both operate on a similar broad principle of rotational farming:
