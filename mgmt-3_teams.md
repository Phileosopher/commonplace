...
3. Development - improving the outputs (product development, [engineering](engineering.md), [maintenance](fix.md), [programming](computers-programming-basics.md), etc.)
...
Do *not* fire someone on an impulse.
