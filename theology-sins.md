...
# What sins are (Harmatiology)

The Bible *constantly* addresses sin, which is any action or thought that goes against what God wants.

- [God is good and fair](theology-god.md), and anything that damages ourselves or others, even when not apparent, is a sin to Him.
...
- Further, most of the laws themselves can still apply in one way or another:
  ...
  - Just over a quarter of them apply to the priesthood (which may or may not apply depending on [how you interpret their role](people-conflicts-christian-3_near.md)).
  - Just over a quarter can be categorized into quite a few domains that can still apply:
    - People with servants ([managers](mgmt-1_why.md))
    - [Farmers](plants.md)
    - High priests
    - Foreigners
...
- Never stop [speaking with Him](spiritual-exercises-prayer.md) and [reading His word](theology-bible.md).
