...
We only create because we [believe](understanding-certainty.md) the creation will fulfill a future [purpose](purpose.md), and we can usually [imagine](mind-imagination.md) its [results](results.md).
...
Broadly speaking, across [societies](groups-large.md), people use a few major [angles](people-image-why.md) that refine [chaos](unknown.md) into [meaning](meaning.md). The creators' efforts funnel into an approximate [trend](people-trends.md) derived from how much [understanding](understanding.md) they have of the subject:
...
4. Pioneering - taking [risks](entrepreneur-why.md) to build order from [chaos](unknown.md) using [known-working](understanding-certainty.md) solutions.
...
APPLICATION: Beyond appreciating creations, we can find a tremendous amount of [purpose](purpose.md) in [understanding](understanding.md) *why* those people created something.
...
The natural result of most significant hacks is that they're a tremendous [social risk](entrepreneur-why.md). Compared to [what they can gain from it](power.md), most hackers either don't [know](understanding.md) or don't [care](purpose.md).
...
- The creator's capacity to create, which is limited by their [human](humanity.md) constraints, [understanding](understanding.md), and [personality](people-personality.md)
...
APPLICATION: Don't disrespect early [trendsetters](people-trends.md). They didn't have the pre-existing [understanding](understanding.md) of the finished creation that you, the current observer, possess. Creations always take more [work](results.md) and [risk](entrepreneur-why.md) than they [appear](people-image-why.md) to.
