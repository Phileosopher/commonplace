...
Depictions of heaven and hell (as well as any other variations, including Nirvana) are [moral balancing](morality.md) for the [unfair situations](morality-evil.md) we often find ourselves exposed to in this life. It's inescapably connected to some form of [judging authority](boundaries.md), though the rules move around a *lot* based on [implementation](religion-answers.md).
...
[Intelligent](understanding.md) beings are often seen as [contenders](boundaries.md) with the gods, and often as villains.
