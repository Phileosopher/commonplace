...
- Databases, including [hacked data](computers-infosec-pentest.md)
- Trade secrets
...
- They also typically hire staff who test whether the content is [malware](computers-infosec-cysec-malware.md) before seeding it.
...
The chances of finding [malware](computers-infosec-cysec-malware.md) on a public tracker is *much* higher, as well as the odds of being monitored by a government intelligence agency.
...
3. Couriers/"racers" - individuals who trade content between pirated sites.
   ...
   - Alongside FTP, they'll use an IRC [sub-protocol](standards-computers.md) called XDCC to upload large files, often on [compromised computers](computers-infosec-pentest.md).
...
4. Average people - individuals who simply want a free or non-DRM version of media/software.
   - Since software is executable, most [malware](computers-infosec-cysec-malware.md) for many people comes bundled within public torrents.
   - For the most part, if a user simply [virus scans](computers-infosec.md) any downloaded content, they won't get any malware.
...
In short, piracy is a portion of the never-ending arms race within the larger domain of [cybersecurity](computers-infosec.md). Every site torn down is only a fraction of where the content is available.
...
The natural design of DRM is to prevent complete use of a product. Sometimes, this can mean the product is *completely* unusable, especially if the company goes out of business and no longer maintains the necessary [authentication](computers-infosec-authentication.md) measures for that DRM.
