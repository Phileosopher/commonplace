...
Air-gapped - a network that has no radio connection to send signals (i.e., no Wi-Fi, bluetooth, etc.)
...
APT - advanced persistent threat, malware designed to stay intentionally undetected
...
ASD - [autism spectrum disorder](mind-neurodivergence-autism.md), a neurological disorder representing a minority of society that becomes a proportionally larger minority in technology work
...
Blended threat - malware with multiple components

Block - a primitive of file management that represents a fixed amount of memory

Block device encryption - aka data-at-rest encryption, encrypting an entire drive as opposed to files or folders on that drive
...
BYOD - bring your own device, a security policy that empowers users to use their own devices
