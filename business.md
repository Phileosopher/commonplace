...
- Someone's business may be [poultry farming](livestock.md) or [custodial work](home-housekeeping.md), but they still must do the same of some things as [distributed internet hosting providers](cs-distsys.md) or [taxi drivers](autos.md).
...
- In the course of their work, an **[entrepreneur](entrepreneur-1_what.md)** will perform *all* the skills in some capacity, and eventually must delegate [if they scale](entrepreneur-6_scaling.md).
