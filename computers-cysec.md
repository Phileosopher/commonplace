...
1. Confidentiality: avoid unauthorized access of information.
2. Integrity: the information is from who you think it is, and hasn't been modified since it was sent.
3. Availability: it needs to be available for everyone who needs to access it.
...
Further, the more complexity in the system, the more risks inherent to the system, since it creates more [attack vectors](computers-cysec-pentest.md).
