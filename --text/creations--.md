We value hard work, and consume things based on that perception
  Even if it's NOT hard work, it has to LOOK it




Underneath the new image, the mechanisms behind most things are mostly the same. There's more in common between one automobile to another, or one person to another, or one book to another than different. However, we presume those similarities and focus so heavily on the differences that most [large-scale conflicts](people-conflicts-war-why.md) revolve around that differentiating 0.00005%.
